...
def get_user_info():
    process = subprocess.Popen("chcp 1251 & powershell Get-LocalUser", shell=True, stdout=subprocess.PIPE,
...
def get_progs_info():
    process = subprocess.Popen(
        'chcp 1251 & powershell -ExecutionPolicy Bypass -command "Get-ItemProperty '
    ...
    output, error = process.communicate()
    print("Информация об установленном программном обеспечении")
    print("--------------------------------------------------")
    print(output[31:])
...
def get_internet_info():
    process = subprocess.Popen(["netstat"], stdout=subprocess.PIPE,
                               stderr=subprocess.PIPE, text=True)
    time.sleep(0.5)
    os.kill(process.pid, signal.SIGINT)

    output, error = process.communicate()
    print("Информация о сетевых соединениях")
    print("--------------------------------------------------\n")
    print(" Имя    Локальный адрес        Внешний адрес          Состояние")
    print(output[88:])
...
def main():
    ...
    print("Информация об оборудовании")
    print("--------------------------------------------------\n")
